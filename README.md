...
1. **In a typical day, what is the probability that the player will be successful overall?**
2. **In a typical day, how many maximal losing streaks of various sizes should a player expect to experience?**
